    ...
    <div>
      ...
      <div className="grid lg:grid-cols-12 mx-auto px-4 py-8 max-w-screen lg:py-16">
        <div className="lg:col-span-7 place-self-center mr-auto">
          ...
          <p className="hero_desc">
            Upload your photo , choose a mode and pick from over 40 room designs
            styles.
            <strong>
      ...
      <section>
        ...
        <div className="text-center mt-5 text-lg font-light text-gray-500 max-w-4xl md:text-lg mx-auto">
          AI automatically re-designs your home interior with over 40 styles of
          room designs. Upload your photo , choose a mode and pick from over 40
          room designs styles. Reimagine Any Home Interior With Our AI Room
          Designs. AI-Powered Room and landscaping designs for your home.
        </div>
